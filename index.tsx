...
const App = () => {
    ...
    const handleGenerateRoutine = async () => {
      ...
      try {
        ...
        setDietPlan(null);
        setActiveTab('training');
        // El accessCode no se regenera aquí para mantener el código existente del cliente.
                      ...
                      <div className="actions-bar">
                        ...
                        <section className="results-section">
                            ...
                            {activeTab === 'training' && (<>
                              ...
                              {!isLoading && !routine && <p className="placeholder">Completá el perfil del cliente/a y generá un plan de entrenamiento.</p>}
                                ...
                                <div className="diet-plan-container">
                                    {loadingDiet && (
                                        <div className="loading-container">
                                            ...
                                            <p>Armando el plan de nutrición...</p>
                                        </div>
                                    )}
